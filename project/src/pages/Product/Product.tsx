  ...
  if (product) {
    ...
    <div>
      <div className={style["header"]}>
        ...
        <Button appearence={"small"} className={style["header-button"]}> <img src="/basket.svg"alt=""  className={style["header-button-img"]}/> В корзину</Button>
        </div>
        ...
        <div className={style["description"]}> 
            ...
            <ul className= {style["description-text"]}>
              {product.ingredients.map((elem) => <li>{elem}</li>)}
